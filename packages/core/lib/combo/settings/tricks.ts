...
export const TRICKS: Tricks = {
  ...
  GLITCH_OOT_EQUIP_SWAP: {
    ...
    name: "Equip Swap (OoT)",
    glitch: true,
    tooltip: "Equiping a restricted item when normally you cannot",
    linkVideo: 'https://www.youtube.com/watch?v=OAFY5IxOJRA',
  },
  GLITCH_OOT_OCARINA_ITEMS: {
    game: 'oot',
    name: "Ocarina Items (OoT)",
    glitch: true,
    tooltip: "Allowing the Player to play songs without Ocarina",
    linkVideo: 'https://www.youtube.com/watch?v=8p8ilVmTZ-w',
  },
  GLITCH_OOT_MEGAFLIP: {
    game: 'oot',
    name: "Megaflips (OoT)",
    glitch: true,
    tooltip: "Extending Link's backflip with bombs",
    linkVideo: 'https://www.youtube.com/watch?v=F4KDPo8lXA4',
  },
  MM_HIVE_BOMBCHU: {
    game: 'mm',
  ...
  GLITCH_MM_MEGAFLIP: {
    ...
    glitch: true,
    tooltip: "Extending Link's backflip with bombs",
    linkVideo: 'https://youtu.be/ASO5ejq4YR0?t=3048',
  },
  GLITCH_MM_ACTIONSWAP: {
    game: 'mm',
    name: "Action Swap",
    glitch: true,
    tooltip: "Changing the damage value of the Stick to correlate with Fire Arrows",
    linkVideo: 'https://youtu.be/ASO5ejq4YR0?t=2938',
  },
  GLITCH_MM_WEIRDSHOT: {
    game: 'mm',
    name: "Weirdshot",
  ...
  GLITCH_MM_BOMB_HOVER: {
    ...
    name: "Bomb Hover",
    glitch: true,
    tooltip: "Hovering with Bombs to get to places you normally cannot",
    linkVideo: 'https://youtu.be/ASO5ejq4YR0?t=530',
  },
  GLITCH_MM_BLAST_HOVER: {
    game: 'mm',
    name: "Blast Mask Hover",
    glitch: true,
    tooltip: "Hovering with Blast Mask to get to places that normal Bomb Hovering cannot reach due to ammo limits",
    linkVideo: 'https://youtu.be/ASO5ejq4YR0?t=530',
  },
  GLITCH_MM_ISG_ANYWHERE: {
    ...
    name: "ISG Anywhere",
    glitch: true,
    tooltip: "Gaining Infinite Sword Glitch anywhere by the use of items",
    linkVideo: 'https://youtu.be/ASO5ejq4YR0?t=290' ,
  },
  GLITCH_MM_ISG_INTERACTION: {
    game: 'mm',
    name: "ISG from Interactions",
    glitch: true,
    tooltip: "Gaining Infinite Sword Glitch by interacting with objects such as signs",
    linkVideo: 'https://youtu.be/ASO5ejq4YR0?t=290',
  },
  GLITCH_MM_SEAMWALK: {
    game: 'mm',
    name: "Seamwalks",
    glitch: true,
    tooltip: "Using the seams of the geometery to walk up slopes",
    linkVideo: 'https://www.youtube.com/watch?v=wYGT3DYjZYo',
  },
  GLITCH_MM_QPA: {
    game: 'mm',
    name: "Quick Put Away",
    glitch: true,
    tooltip: "Puting away stick change the damage value to duplicate the Goron Punch",
    linkVideo: 'https://www.youtube.com/watch?v=I_J8tP1zqV4',
  },
  GLITCH_MM_WATER_LIGHTS: {
    game: 'mm',
    name: "Activating Sunswitches with Water",
    glitch: true,
    tooltip: "Dumping Spring Water on Certain Sun blocks and switches to activate them",
    linkVideo: 'https://www.youtube.com/watch?v=YAUxwb_b46I',
};
